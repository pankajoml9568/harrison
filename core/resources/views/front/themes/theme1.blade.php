            ...
            <div class="container">
                ...
                <div class="row"> 
                    <div class="col-12 text-center">
                        <a href="{{ url('news-media') }}" class="btn btn-link thin btn-extra-large text-extra-dark-gray margin-30px-top d-inline-block md-margin-40px-top sm-margin-20px-top">View all updates</a>
                    </div>
                </div>     
            </div>
        </section>
