                    ...
                    <div class="col-12 col-lg-11 box-shadow-medium bg-white align-items-center justify-content-center padding-6-rem-all md-padding-3-rem-all">
                        <div class="row align-items-center justify-content-center mx-lg-0">
                            ...
                            <div class="col-12 col-xl-5 col-md-6 col-sm-11 text-center text-md-left sm-margin-20px-tb">
                                ...
                                <a href="<?php echo e(url('become-a-dealer/#dealerform')); ?>" class="btn btn-small btn-dark-gray">Become a partner</a>
                            </div>
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <!-- end section -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www\harrison\core\resources\views/front/forms/become-a-associate.blade.php ENDPATH**/ ?>